                        ...
                        <div class="row p-t-50">
                            <div class="col-sm-12">
                                <div class="m-b-20 table-responsive">
                                    <h5><b>Ini Data Barang</b></h5>
                                    <p class="text-muted font-13 m-b-30">
                                        <a href="<?php echo base_url('barang/add'); ?>" class="btn btn-danger">(+) Add</a>
                                    </p>
                                    ...
                                    <table id="datatable-buttons" class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                            <?php 
                                            $no=0;
                                            foreach ($barang as $rows): $no++ ?>
                                                <tr>
                                                    <td><?php echo $no; ?></td>
                                                    <td><?php echo $rows['jenis_barang']; ?></td>
                                                    <td><?php echo $rows['harga_perkilo']; ?></td>
                                                    
                                                    <td align="center">
                                                        <a href="<?php echo base_url('barang/editData/'.$rows['id']); ?>"><i class="fa fa-pencil"> </i></a>
                                                        &nbsp;&nbsp;
                                                        <a href="<?php echo base_url('barang/deleteData/'.$rows['id']); ?>" onclick="return confirm('Apakah anda ingin menghapus data ini?')" href=""><i class="fa fa-trash"> </i></a>
                                                    </td>
                                                </tr>
                                            <?php endforeach ?>
                                        </tbody>
