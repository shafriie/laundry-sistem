            ...
            <div class="page-contentbar">
                ...
                <div id="page-right-content">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-12">
                                <h4 class="header-title m-t-0 m-b-20">Form Edit Barang</h4>
                            </div>
                        </div> <!-- end row -->
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <form method="POST" class="form-horizontal" role="form" action="<?php echo base_url('barang/update'); ?>">
                                            <div class="form-group">
                                                <label class="col-md-2 control-label">Jenis Barang</label>
                                                <div class="col-md-10">
                                                    <input type="hidden" name="id" value="<?php echo $id ?>">
                                                    <input type="text" class="form-control" name="jenis_barang" placeholder="Jenis Barang" required value="<?php echo $jenis_barang ?>">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-2 control-label">Harga per Kilo</label>
                                                <div class="col-md-10">
                                                    <input type="number" name="harga_perkilo" class="form-control" value="<?php echo $harga_perkilo ?>">
                                                </div>
                                            </div>
