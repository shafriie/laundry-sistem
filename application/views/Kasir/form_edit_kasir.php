            ...
            <div class="page-contentbar">
                ...
                <div id="page-right-content">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-12">
                                <h4 class="header-title m-t-0 m-b-20">Form Edit Kasir</h4>
                            </div>
                        </div> <!-- end row -->
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <form method="POST" class="form-horizontal" role="form" action="<?php echo base_url('kasir/updateKasir'); ?>">
                                            <div class="form-group">
                                                <label class="col-md-2 control-label">Nama Kasir</label>
                                                <div class="col-md-10">
                                                    <input type="hidden" name="id_kasir" value="<?php echo $id_kasir ?>">
                                                    <input type="text" class="form-control" name="nama" placeholder="Nama Kasir" required value="<?php echo $nama_kasir ?>">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-2 control-label">Alamat</label>
                                                <div class="col-md-10">
                                                    <textarea required class="form-control" rows="5" name="alamat" placeholder="Alamat"><?php echo $alamat ?></textarea>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-2 control-label">No Telepon</label>
                                                <div class="col-md-10">
                                                    <input required type="no_telp" name="no_telp" class="form-control" placeholder="No Telepon" value="<?php echo $no_telp ?>">
                                                </div>
                                            </div>
