            ...
            <div class="page-contentbar">
                ...
                <div id="page-right-content">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-12">
                                <h4 class="header-title m-t-0 m-b-20">Kasir</h4>
                            </div>
                        </div> <!-- end row -->
                        ...
                        <div class="row p-t-50">
                            <div class="col-sm-12">
                                <div class="m-b-20 table-responsive">
                                    <h5><b>Ini Data Kasir</b></h5>
                                    <p class="text-muted font-13 m-b-30">
                                        <a href="<?php echo base_url('kasir/add'); ?>" class="btn btn-danger">(+) Add</a>
                                    </p>
                                    ...
                                    <table id="datatable-buttons" class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                            <?php 
                                            $no=0;
                                            foreach ($kasirs as $kasir): $no++ ?>
                                                <tr>
                                                    <td><?php echo $no; ?></td>
                                                    <td><?php echo $kasir['nama_kasir']; ?></td>
                                                    <td><?php echo $kasir['alamat']; ?></td>
                                                    <td><?php echo $kasir['no_telp']; ?></td>
                                                    <td align="center">
                                                        <a href="<?php echo base_url('kasir/editData/'.$kasir['id_kasir']); ?>"><i class="fa fa-pencil"> </i></a>
                                                        &nbsp;&nbsp;
                                                        <a onclick="return confirm('Apakah menghapus data ini?')" href="<?php echo base_url('kasir/deleteData/'.$kasir['id_kasir']); ?>"><i class="fa fa-trash"> </i></a>
                                                    </td>
                                                </tr>
                                            <?php endforeach ?>
                                        </tbody>
