            ...
            <div class="page-contentbar">
                ...
                <div id="page-right-content">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-12">
                                <h4 class="header-title m-t-0 m-b-20">Form Input Layanan</h4>
                            </div>
                        </div> <!-- end row -->
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <form method="POST" class="form-horizontal" role="form" action="<?php echo base_url('layanan/insert'); ?>">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <input required type="number" name="harga" class="form-control" placeholder="Harga">
                                                </div>
                                            </div>
