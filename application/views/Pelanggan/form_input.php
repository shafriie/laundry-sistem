            ...
            <div class="page-contentbar">
                ...
                <div id="page-right-content">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-12">
                                <h4 class="header-title m-t-0 m-b-20">Form Input Pelanggan</h4>
                            </div>
                        </div> <!-- end row -->
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <form method="POST" class="form-horizontal" role="form" action="<?php echo base_url('pelanggan/insertPelanggan'); ?>">
