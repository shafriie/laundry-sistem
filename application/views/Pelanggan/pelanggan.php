            ...
            <div class="page-contentbar">
                ...
                <div id="page-right-content">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-12">
                                <h4 class="header-title m-t-0 m-b-20">Pelanggan</h4>
                            </div>
                        </div> <!-- end row -->
                        ...
                        <div class="row p-t-50">
                            <div class="col-sm-12">
                                <div class="m-b-20 table-responsive">
                                    <h5><b>Ini Data Pelanggan</b></h5>
                                    <p class="text-muted font-13 m-b-30">
                                        <a href="<?php echo base_url('pelanggan/add'); ?>" class="btn btn-danger">(+) Add</a>
                                    </p>
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($pelanggans as $pelanggan): $no++ ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo $pelanggan['fullname']; ?></td>
                                                    <td><?php echo $pelanggan['password']; ?></td>
                                                    <td align="center">
                                                        <a href="<?php echo base_url('pelanggan/editData/'.$pelanggan['id']); ?>"><i class="fa fa-pencil"> </i></a>
                                                        &nbsp;&nbsp;
                                                        <a onclick="return confirm('Apakah anda ingin menghapus data ini?')" href="<?php echo base_url('pelanggan/deleteData/'.$pelanggan['id']); ?>"><i class="fa fa-trash"> </i></a>
                                                    </td>
                                                </tr>
                                            <?php endforeach ?>
                                        </tbody>
