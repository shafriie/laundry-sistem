                        ...
                        <div class="wrapper-page">
                                ...
                                <div class="text-center">
                                    <h2 class="text-uppercase m-t-0 m-b-30">
                                        <a href="<?php echo base_url('dashboard'); ?>" class="text-info">
                                            <span><span>Sistem Laundry</span></span>
                                        </a>
                                    </h2>
                                    <!--<h4 class="text-uppercase font-bold m-b-0">Sign In</h4>-->
                                </div>
                                <div class="account-content">
                                    <form class="form-horizontal" action="<?php echo base_url('register/registerCustomer'); ?>" method="POST">
                                        ...
                                        <div class="form-group m-b-20">
                                            <div class="col-xs-12">
                                                ...
                                                <input class="form-control" type="text" id="fullname" required="" placeholder="Full Name" name="fullname">
                                            </div>
                                        </div>
                            ...
                            <div class="row m-t-50">
                                <div class="col-sm-12 text-center">
                                    <p class="text-muted">Already have an account?  <a href="<?php echo base_url('login'); ?>" class="text-dark m-l-5">Sign In</a></p>
                                </div>
                            </div>
